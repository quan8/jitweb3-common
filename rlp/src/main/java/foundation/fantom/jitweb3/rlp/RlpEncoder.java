 ...
 */
package foundation.fantom.jitweb3.rlp;

import java.util.Arrays;
import java.util.List;

import static foundation.fantom.jitweb3.rlp.RlpDecoder.OFFSET_SHORT_LIST;
import static foundation.fantom.jitweb3.rlp.RlpDecoder.OFFSET_SHORT_STRING;
