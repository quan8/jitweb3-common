 ...
 */
package foundation.fantom.jitweb3.crypto.transaction.type;

import java.math.BigInteger;
import java.util.ArrayList;
import java.util.List;

import foundation.fantom.jitweb3.crypto.Sign;
import foundation.fantom.jitweb3.rlp.RlpList;
import foundation.fantom.jitweb3.rlp.RlpString;
import foundation.fantom.jitweb3.rlp.RlpType;
import foundation.fantom.jitweb3.utils.Bytes;
import foundation.fantom.jitweb3.utils.Numeric;

import static foundation.fantom.jitweb3.crypto.transaction.type.TransactionType.EIP1559;
