 ...
 * Typed {@link foundation.fantom.jitweb3.abi.datatypes.Array} types.
 *
 ...
 */
public abstract class TypeReference<T extends foundation.fantom.jitweb3.abi.datatypes.Type>
    ...
    public static <T extends foundation.fantom.jitweb3.abi.datatypes.Type> TypeReference<T> create(Class<T> cls) {
        return create(cls, false);
    }

    public static <T extends foundation.fantom.jitweb3.abi.datatypes.Type> TypeReference<T> create(
     ...
     */
    protected static Class<? extends foundation.fantom.jitweb3.abi.datatypes.Type> getAtomicTypeClass(
    ...
    public abstract static class StaticArrayTypeReference<T extends foundation.fantom.jitweb3.abi.datatypes.Type>
    ...
    public static TypeReference makeTypeReference(
        ...
        if (!nextSquareBrackets.find()) {
            final Class<? extends foundation.fantom.jitweb3.abi.datatypes.Type> typeClass =
        ...
        final Class<? extends foundation.fantom.jitweb3.abi.datatypes.Type> baseClass =
        ...
        while (lastReadStringPosition < len) {
            ...
            if (arraySize == null || arraySize.equals("")) {
                ...
                if (arraySizeInt <= StaticArray.MAX_SIZE_OF_STATIC_ARRAY) {
                    arrayclass =
                            Class.forName(
                                    "foundation.fantom.jitweb3.abi.datatypes.generated.StaticArray" + arraySize);
                } else {
